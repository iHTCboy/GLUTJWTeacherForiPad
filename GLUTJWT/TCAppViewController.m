...
//        cell.imageView.image = [UIImage imageNamed:@"JWTlogomini.png"];
        ...
        cell.accessoryType = UITableViewCellAccessoryDisclosureIndicator;
        cell.textLabel.text = @"桂林理工大学";
        cell.detailTextLabel.text = @"学生iPad版:课表、教务、校历、作息时间等查看，方便学生通过iPad，快速的登陆教务系统，了解教学的相关事务。";
...
//        UIActionSheet * sheets = [[UIActionSheet alloc]initWithTitle:@"桂林理工大学教务在线——教师iOS版" delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"从AppStore下载",@"短信告诉好友",@"邮件告诉好友", nil];
        ...
        UIActionSheet * sheets = [[UIActionSheet alloc]initWithTitle:@"桂林理工大学教务在线——学生iPad版" delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"从AppStore下载",@"短信告诉好友",@"邮件告诉好友", nil];
...
-(void)downSJwWithactionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    {
        //短信
        [self sendMessageWithBody:@"童鞋，推荐你使用这款应用，这是桂林理工大学教务在线---学生iPad客户端，主要是学生登陆，可以查看校历、作息时间，最重要的是学生教学管理，方便学生通过手机，快速的登陆教务系统，了解教学的相关事务。您也快来下载啊！\nAppStore下载: https://appsto.re/cn/hoxG2.i"];
    }
    else if(buttonIndex == 2)
    {
        //邮件
        [self sendEmeilTitle:@"童鞋，快来下载这款应用啊！" withBody:@"童鞋，推荐你使用这款应用，这是桂林理工大学教务在线---学生iPad客户端，主要是学生登陆，可以查看校历、作息时间，最重要的是学生教学管理，方便学生通过手机，快速的登陆教务系统，了解教学的相关事务。您也快来下载啊！\nAppStore下载: https://appsto.re/cn/hoxG2.i "];
