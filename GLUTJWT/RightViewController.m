...
- (void)viewDidLoad
{
    ...
    //职务
    UILabel * worksLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.view.center.x  , self.view.center.y * 0.9, 200, 40)];
    worksLabel.backgroundColor = [UIColor clearColor];
    worksLabel.font = [UIFont boldSystemFontOfSize:23];
    ...
    //worksLabel.text = @"教授";
     ...
     //科室
    UILabel * classLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.view.center.x  , self.view.center.y * 0.98, 200, 40)];
    ...
    UILabel * collegeLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.view.center.x  * 0.92, self.view.center.y * 1.06, 250, 40)];
    ...
    //取消按钮
    UIButton * cancel =[[UIButton alloc]initWithFrame:CGRectMake(self.view.center.x * 0.93 , self.view.center.y * 5/3.5, 300, 55)];
